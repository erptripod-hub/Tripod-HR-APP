...
def get_employee_details(employee):
	...
	data = {
		...
		"nationality": getattr(emp, "country", None) or getattr(emp, "nationality", None),
		"emirates_id": getattr(emp, "identification_no", None) or getattr(emp, "iqama_no", None) or getattr(emp, "emirates_id", None),
